...
template<>
struct PI<float> {
  static constexpr float value = 3.141592f;
};

template<>
struct PI<double> {
  static constexpr double value = 3.141592653589;
};

template<>
struct PI<long double> {
  static constexpr long double value = 3.14159265358979323846l;
};
...
public:
  ...
  {
    constexpr double RAD_TO_DEG = 180.0 / PI<double>::value;
  ...
  draw_image_90(Image *img, Float2 center,
                ...
                SDL_RendererFlip flip = SDL_FLIP_NONE)
  {
    draw_image(img, center, angle + PI<float>::value*0.5f, flip);
  }
  ...
  draw_image_90(Image *img, Float2 center,
                ...
                SDL_RendererFlip flip = SDL_FLIP_NONE)
  {
    draw_image(img, center, angle + PI<float>::value*0.5f, rot_center, flip);
  }
  ...
  draw_image_180(Image *img, Float2 center,
                 ...
                 SDL_RendererFlip flip = SDL_FLIP_NONE)
  {
    draw_image(img, center, angle + PI<float>::value, flip);
  }
  ...
  draw_image_180(Image *img, Float2 center,
                 ...
                 SDL_RendererFlip flip = SDL_FLIP_NONE)
  {
    draw_image(img, center, angle + PI<float>::value, rot_center, flip);
  }
