...
fire(ParticlesSystem *particles, uint32_t ms_now) noexcept {
  ...
  batch_setup.spread_angle = PI<float>()*0.075f;
  batch_setup.ms_min_vel = 0.02f;
  batch_setup.ms_max_vel = 0.3f;
  batch_setup.color = {static_cast<uint8_t>(32 + 16*RAND_01_f()),
                       static_cast<uint8_t>(24 + 12*RAND_01_f()),
                       190,
                       255};
